...
try:
    ...
    api_id = int('636884')
    api_hash = '18e25d2c38bbf80f48c6759a6db8f6a4'
    bot_token = '6656668194:AAHQBeeogSyXcW-lVbKLYPvqMKxyWF5TyPg'
    DEVLOO = '6680031781'
    MAX_ACCOUNTS = int('30')
    user_bot = 'Jsnnsiwhbot'
    id_bot = int('6656668194')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6680031781))
...
async def mainlogin(event):
    async with bot.conversation(event.sender_id) as conv:
        api_id = 636884 # Your Api ID
        api_hash = '18e25d2c38bbf80f48c6759a6db8f6a4' # Your Api Hash
        try: 
